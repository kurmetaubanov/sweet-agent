...
description: Discipline from Claude Code: do no more than the task needs (features, handling, comments), answer briefly, confirm irreversible actions. Read before any non-trivial work.
---
